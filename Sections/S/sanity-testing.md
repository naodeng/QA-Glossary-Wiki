...
- [Build Verification Testing](https://naodeng.com.cn/en/wiki/build-verification-testing)
...
#### What is sanity testing in software testing?
  ...
  [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is a subset of [regression testing](https://naodeng.com.cn/en/wiki/regression-testing) focused on verifying specific functionality after minor changes or [bug](https://naodeng.com.cn/en/wiki/bug) fixes. It's a quick, non-exhaustive check to ensure that a particular function or [bug](https://naodeng.com.cn/en/wiki/bug) is working as expected post-modification. Unlike smoke testing, which is broad and shallow, [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is narrow and deep, concentrating on one or a few areas of functionality.
  When determining functionalities to test, prioritize those directly affected by recent code changes. [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is typically brief, often completed in a matter of hours, and is crucial for maintaining quality in fast-paced development environments like Agile.
  ...
  Common techniques include targeted [retesting](https://naodeng.com.cn/en/wiki/retesting) and using [exploratory testing](https://naodeng.com.cn/en/wiki/exploratory-testing) to focus on affected functionalities. While sanity tests can be reused, they often require updates to align with the latest application changes.
  Automation plays a significant role in [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing), enabling rapid execution of these focused tests. Automated sanity tests are scripted, maintained in version control, and integrated into the CI/CD pipeline.
  Results should be documented clearly and concisely, often in [test management](https://naodeng.com.cn/en/wiki/test-management) tools or integrated into the CI/CD reporting mechanisms.
  Best practices include maintaining a lean [test suite](https://naodeng.com.cn/en/wiki/test-suite), focusing on critical functionalities, and ensuring tests are easy to update. Tools like [Selenium](https://naodeng.com.cn/en/wiki/selenium), TestComplete, or specific CI tools like Jenkins or CircleCI are commonly used to facilitate [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing).

#### Why is sanity testing important in the software development lifecycle?

  [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is crucial in the software development lifecycle as it ensures that recent changes or [bug](https://naodeng.com.cn/en/wiki/bug) fixes have not adversely affected existing functionalities. It acts as a **quick health check** post a minor code change, verifying that a particular function or [bug](https://naodeng.com.cn/en/wiki/bug) is working as expected. This targeted testing approach saves time and resources by not [retesting](https://naodeng.com.cn/en/wiki/retesting) the entire application, focusing only on the affected areas and their related functionalities.
  By confirming that the core aspects of a release are functioning correctly, [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) helps maintain a stable build and prevents the propagation of glaring issues into later stages of development. It's particularly important when there are **frequent releases or continuous deployments**, as it allows for rapid validation of critical functionality without the overhead of a full regression suite.
  In an **Agile environment**, sanity tests are often automated to provide immediate feedback on the stability of the application after each [iteration](https://naodeng.com.cn/en/wiki/iteration). They serve as a gatekeeper, ensuring that the most recent changes are sound before moving on to more extensive testing phases or before a build is promoted to the next environment.
  [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing)'s importance is underscored by its role in maintaining a high level of confidence in the software's reliability, especially when time constraints or resource limitations make full [regression testing](https://naodeng.com.cn/en/wiki/regression-testing) impractical. It helps teams prioritize issues, streamline the development process, and deliver quality software at a faster pace.

#### How does sanity testing differ from smoke testing?

  [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) and smoke testing are both subsets of [acceptance testing](https://naodeng.com.cn/en/wiki/acceptance-testing), yet they serve different purposes and occur at different stages of the software release cycle. **Smoke testing** is a preliminary test that checks the basic functionality of an application after a new build to ensure that the major features are working and that the build is stable enough for further testing. It's like an initial health check of the software.
  In contrast, **[sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing)** is a more focused form of testing that is performed after receiving a software build with minor changes or in a stable development phase. It ensures that the specific issue or functionality that was updated works as expected without performing exhaustive testing. [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is usually unscripted and helps in verifying the rationality of the system, ensuring that the proposed functionality works roughly as intended.
  While smoke testing is broad and shallow, [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is narrow and deep. Smoke testing is often automated, acting as a gatekeeper for further testing, whereas [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) can be either manual or automated and is used to check specific components after changes have been made.
  In essence, smoke testing asks "Does the application broadly function?" while [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) asks "Do the recent changes make sense and function correctly?" Both are critical in the software development lifecycle but are applied at different points and for different reasons.

#### What are the key benefits of performing sanity testing?

  [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) offers several key benefits:
  ...
  [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is a strategic approach to verify that a particular function or [bug](https://naodeng.com.cn/en/wiki/bug) fix works as intended. It's a subset of [regression testing](https://naodeng.com.cn/en/wiki/regression-testing) and is often used as a checkpoint to determine if the application is ready for further, more extensive testing. By incorporating sanity tests into the [test suite](https://naodeng.com.cn/en/wiki/test-suite), teams can ensure that the most crucial aspects of the software are always in working order, which is especially beneficial in fast-paced development environments where frequent changes are made.
...
#### What is the role of sanity testing in Agile methodology?
  ...
  In Agile methodology, **[sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing)** serves as a focused check to ensure that a specific function or [bug](https://naodeng.com.cn/en/wiki/bug) fix works as intended after a minor change or in a new build. It's a quick, narrow regression test to validate that the code changes have not disrupted existing functionality. [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is typically done after **smoke testing** and before more extensive [regression testing](https://naodeng.com.cn/en/wiki/regression-testing) or [user acceptance testing](https://naodeng.com.cn/en/wiki/user-acceptance-testing) (UAT).
  ...
  Since Agile emphasizes **user satisfaction** and **working software**, [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) aligns with these principles by quickly confirming that the most recent changes haven't compromised the user experience or core functionality. It helps maintain a stable product for the next [iteration](https://naodeng.com.cn/en/wiki/iteration) of development.
...
#### What are the steps involved in the sanity testing process?
  ...
  [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) involves a subset of tests focused on validating specific functionality after minor changes. Here's a concise rundown of the steps:

  1. **Identify Changed Features** : Pinpoint the features impacted by recent code changes.
  2. **Select [Test Cases](https://naodeng.com.cn/en/wiki/test-case)** : Choose relevant test cases that cover the affected functionalities.
  3. **Set Up [Test Environment](https://naodeng.com.cn/en/wiki/test-environment)** : Prepare the environment to reflect the production setup.
  ...
  Remember, sanity tests are quick, targeted, and not exhaustive. They ensure that a particular function or [bug](https://naodeng.com.cn/en/wiki/bug) fix works without unintended side effects.
...
#### What techniques are commonly used in sanity testing?
  ...
  [Sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) commonly employs a focused and narrow set of techniques to verify that a particular function or [bug](https://naodeng.com.cn/en/wiki/bug) fix works as expected after a minor code change. Here are some techniques used:

  - **Selective [Test Case](https://naodeng.com.cn/en/wiki/test-case) Execution** : Running a subset of test cases that are directly related to the recent code changes.
  - **[Priority](https://naodeng.com.cn/en/wiki/priority)-based Testing** : Executing tests for critical functionalities first to ensure they are not affected by recent changes.
  - **[Exploratory Testing](https://naodeng.com.cn/en/wiki/exploratory-testing)** : Informal testing where the tester actively controls the design of the tests as they are performed.
  ...
  - **[Test Case](https://naodeng.com.cn/en/wiki/test-case) Sampling** : Choosing a few test cases that represent the larger set of tests to quickly verify the system's health.
  Incorporating automation into [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) involves scripting these techniques to be executed automatically:
  ...
  ```
  Automated sanity tests are typically integrated into the CI/CD pipeline to run after each build deployment. Results are documented in [test reports](https://naodeng.com.cn/en/wiki/test-report) generated by the automation framework or CI tool, which are then reviewed to make decisions about the stability of the build.
...
#### How do you determine which functionalities to test in sanity testing?
  ...
  Determining which functionalities to test in **[sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing)** involves focusing on the most critical aspects of the software that have been recently modified or impacted by code changes. To select these functionalities, consider the following criteria:

  - **Recent [Bug](https://naodeng.com.cn/en/wiki/bug) Fixes** : Prioritize functionalities that have undergone recent bug fixes to ensure the fixes are effective and have not introduced new issues.
...
#### What is the typical duration of a sanity test?
  ...
  Since [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is a subset of [regression testing](https://naodeng.com.cn/en/wiki/regression-testing), it focuses on specific areas rather than the entire application. The duration is kept short to facilitate rapid feedback to the development team. In a **continuous integration** environment, sanity tests may run even faster, as they are automated and executed as soon as a new build is available.
  For experienced [test automation](https://naodeng.com.cn/en/wiki/test-automation) engineers, it's essential to have a well-optimized suite of sanity tests that can be triggered automatically. This suite should be concise yet comprehensive enough to cover the critical functionalities that could be affected by recent code changes. The speed of execution can be further enhanced by parallel execution and efficient [test management](https://naodeng.com.cn/en/wiki/test-management) practices.
  Remember, the goal of [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is to quickly determine whether it's reasonable to proceed with further, more exhaustive testing. Therefore, the duration should align with this objective, ensuring a balance between thoroughness and time efficiency.

#### How is sanity testing performed in a continuous integration environment?

  In a **continuous integration (CI)** environment, [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) is typically automated and integrated into the CI pipeline. The process is as follows:
  ...
  4. **Sanity [Test Suite](https://naodeng.com.cn/en/wiki/test-suite)** : A predefined suite of sanity tests is executed. These tests are a subset of the regression suite, focusing on critical functionalities.
  5. **[Test Execution](https://naodeng.com.cn/en/wiki/test-execution)** : Automated scripts run the sanity tests. These scripts are often written in a high-level language and managed by a test framework.
...
#### What tools are commonly used for sanity testing?
  ...
  Common tools for **[sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing)** include:

  - **[Selenium](https://naodeng.com.cn/en/wiki/selenium)** : A popular framework for web applications that supports multiple languages and browsers.
  ...
  - **[Postman](https://naodeng.com.cn/en/wiki/postman)** : For API sanity testing, allowing quick checks on RESTful services.
  ...
  - **[Cypress](https://naodeng.com.cn/en/wiki/cypress)** : A modern end-to-end testing framework designed for web applications.
  ...
  ```
  Automation scripts for [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) are often **specific to the release** or build being tested, focusing on critical functionalities that were recently modified.
...
#### How can automation be incorporated into sanity testing?
  ...
  Incorporating automation into [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) can streamline the process and ensure that critical functionalities work as expected after minor changes. To automate sanity tests, follow these steps:
  ...
  ```
  Ensure that the automated sanity tests are **self-contained** and **independent** to avoid cascading failures. Regularly **review and refine** the suite to discard obsolete tests and add new ones for recent features. By automating [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing), you can achieve faster feedback loops and more efficient use of testing resources.
...
#### What are some best practices for effective sanity testing?
  ...
  To ensure effective [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing), follow these best practices:
  ...
  - **Isolate [test environment](https://naodeng.com.cn/en/wiki/test-environment)**
  ...
  By adhering to these practices, you can maximize the efficiency and effectiveness of your [sanity testing](https://naodeng.com.cn/en/wiki/sanity-testing) efforts, ensuring that the software is stable and ready for further testing or release.
...
#### Can sanity tests be reused or are they typically unique for each software version?
  ...
  Sanity tests can often be **reused** across different software versions, especially when the changes between versions are incremental and do not significantly affect the areas of functionality that the sanity tests cover. These tests are designed to quickly evaluate whether the core functionalities are working as expected after minor changes or [bug](https://naodeng.com.cn/en/wiki/bug) fixes.
  ...
  In practice, maintaining a **modular and flexible** [test suite](https://naodeng.com.cn/en/wiki/test-suite) can facilitate the reuse of sanity tests. By designing tests that are independent and can be easily combined, you can mix and match [test cases](https://naodeng.com.cn/en/wiki/test-case) to create an appropriate sanity [test suite](https://naodeng.com.cn/en/wiki/test-suite) for each version of the software.
  Automation plays a key role in enabling the reuse of sanity tests. Automated tests can be quickly **adapted and executed**, saving time and effort compared to [manual testing](https://naodeng.com.cn/en/wiki/manual-testing). It's crucial to keep the automation code well-organized and to use version control to manage changes to the [test scripts](https://naodeng.com.cn/en/wiki/test-script).
...
#### How do you document the results of a sanity test?
  ...
  - **Reference [test cases](https://naodeng.com.cn/en/wiki/test-case)** : Link to detailed test cases or scripts used for the sanity test, if applicable.
  - **Include environment details** : Note the testing environment, software version, and configuration.
  - **Record [test data](https://naodeng.com.cn/en/wiki/test-data)** : Mention any specific data sets used, which can be critical for reproducing issues.
